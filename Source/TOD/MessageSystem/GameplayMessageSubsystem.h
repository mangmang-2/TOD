...
TOD_API DECLARE_LOG_CATEGORY_EXTERN(LogGameplayMessageSubsystem, Log, All);
...
struct TOD_API FGameplayMessageListenerHandle
{
public:
	GENERATED_BODY()
 ...
 */
UCLASS()
class TOD_API UGameplayMessageSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
